  ...
  const initialModalMessage = isSeatLimitExceeded
    ...
    : showRenewalMessage
      ? NEXT_PUBLIC_CLOUD_ENABLED
        ? "Your access to Bina has been temporarily suspended due to a lapse in your subscription."
        : "Your access to Bina has been temporarily suspended due to a lapse in your license."
      : "An Enterprise license is required to use Bina. Your data is protected and will be available once a license is activated.";
  ...
  return (
    <ErrorPageLayout>
      ...
      {isSeatLimitExceeded ? (
        ...
        <>
          <Text text03>
            To reinstate your access and continue benefiting from Bina&apos;s
        ...
        <>
          <Text text03>
            {hadPreviousLicense
              ? "To reinstate your access and continue using Bina, please contact your system administrator to renew your license."
          ...
          <Text text03>
            ...
            <a className={linkClassName} href="mailto:support@bina-bi.ir">
              support@bina-bi.ir
            </a>{" "}
