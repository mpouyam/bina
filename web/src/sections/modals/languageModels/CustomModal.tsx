        ...
        <Section gap={0.75}>
          <Content
            ...
            description={markdown(
              "Add extra properties as needed by the model provider. These are passed to LiteLLM's `completion()` call as [environment variables](https://docs.litellm.ai/docs/set_keys#environment-variables). See [documentation](https://docs.bina-bi.ir/admins/ai_models/custom_inference_provider) for more instructions."
            )}
            width="full"
            variant="section"
